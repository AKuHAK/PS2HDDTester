...
#define I_ata_get_crc_error_count         DECLARE_IMPORT(20, ata_get_crc_error_count)
#define I_ata_reset_crc_error_count       DECLARE_IMPORT(21, ata_reset_crc_error_count)
#define I_ata_device_identify             DECLARE_IMPORT(22, ata_device_identify)
