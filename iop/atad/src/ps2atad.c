...
static u64 ata_crc_error_count = 0;
...
static const ata_cmd_info_t ata_cmd_table[] = {
    ...
    {ATA_C_READ_NATIVE_MAX_ADDRESS_EXT, 0x81},
    {ATA_C_READ_MULTIPLE_EXT, 0x82},
    {ATA_C_WRITE_SECTOR, 3},
    {ATA_C_WRITE_LONG, 8},
    {ATA_C_WRITE_SECTOR_EXT, 0x83},
    {ATA_C_WRITE_DMA_EXT, 0x84},
    {ATA_C_SET_MAX_ADDRESS_EXT, 0x81},
    {ATA_C_CFA_WRITE_SECTORS_WITHOUT_ERASE, 3},
    {ATA_C_WRITE_MULTIPLE_EXT, 0x83},
...
u64 ata_get_crc_error_count()
{
    return ata_crc_error_count;
}

void ata_reset_crc_error_count()
{
    ata_crc_error_count = 0;
}
